			...
			<table class="table text-gray-400 border-separate space-y-6 text-sm">
				...
				<tbody>
					<tr class="bg-gray-100">
						...
						<td class="p-3">
							<span class=" text-gray-400  px-2">John@gmail.com</span>
						</td>
						<td class="p-3 ">
					...
					<tr class="bg-gray-100">
						...
						<td class="p-3">
							<span class=" text-gray-400 rounded-md px-2">Devitchhon@gmail.com</span>
						</td>
						<td class="p-3">
							<a href="#" class="text-gray-400 hover:text-gray-100  mr-2">
								<i class="material-icons-outlined text-base">visibility</i>
					...
					<tr class="bg-gray-100">
						...
						<td class="p-3">
							<span class=" text-gray-400  rounded-md px-2">Jack123@gmail.com</span>
						</td>
						<td class="p-3">
							<a href="#" class="text-gray-400 hover:text-gray-100 mr-2">
								<i class="material-icons-outlined text-base">visibility</i>
